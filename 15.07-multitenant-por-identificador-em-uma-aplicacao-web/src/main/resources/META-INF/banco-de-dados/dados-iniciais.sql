insert into produto (id, tenant, versao, nome, preco, data_criacao, ativo, descricao) values (1, 'loja', 0, 'Kindle', 799.0, date_sub(sysdate(), interval 1 day), 'SIM', 'Conheça o novo Kindle, agora com iluminação embutida ajustável, que permite que você leia em ambientes abertos ou fechados, a qualquer hora do dia.');
insert into produto (id, tenant, versao, nome, preco, data_criacao, ativo, descricao) values (3, 'loja', 0, 'Câmera GoPro Hero 7', 1500.0, date_sub(sysdate(), interval 1 day), 'SIM', 'Desempenho 2x melhor.');
insert into produto (id, tenant, versao, nome, preco, data_criacao, ativo, descricao) values (4, 'loja', 0, 'Câmera Canon 80D', 3500.0, sysdate(), 'SIM', 'O melhor ajuste de foco.');
insert into produto (id, tenant, versao, nome, preco, data_criacao, ativo, descricao) values (5, 'loja', 0, 'Microfone de Lapela', 50.0, sysdate(), 'NAO', 'Produto massa');

insert into cliente (id, tenant, versao, nome, cpf) values (1, 'loja', 0, 'Fernando Medeiros', '000');
insert into cliente (id, tenant, versao, nome, cpf) values (2, 'loja', 0, 'Marcos Mariano', '111');
...
insert into pedido (id, tenant, versao, cliente_id, data_criacao, total, status) values (3, 'loja', 0, 1, date_sub(sysdate(), interval 4 day), 3500.0, 'PAGO');
insert into pedido (id, tenant, versao, cliente_id, data_criacao, total, status) values (4, 'loja', 0, 2, date_sub(sysdate(), interval 2 day), 499.0, 'PAGO');
insert into pedido (id, tenant, versao, cliente_id, data_criacao, total, status) values (5, 'loja', 0, 1, date_sub(sysdate(), interval 2 day), 799.0, 'PAGO');
insert into pedido (id, tenant, versao, cliente_id, data_criacao, total, status) values (6, 'loja', 0, 2, sysdate(), 799.0, 'AGUARDANDO');
...
insert into pagamento (pedido_id, tenant, versao, status, tipo_pagamento, numero_cartao, codigo_barras) values (1, 'loja', 0, 'RECEBIDO', 'cartao', '0123', null);
insert into pagamento (pedido_id, tenant, versao, status, tipo_pagamento, numero_cartao, codigo_barras) values (2, 'loja', 0, 'PROCESSANDO', 'cartao', '4567', null);
insert into pagamento (pedido_id, tenant, versao, status, tipo_pagamento, numero_cartao, codigo_barras, data_vencimento) values (3, 'loja', 0, 'RECEBIDO', 'boleto', null, '8910', date_sub(sysdate(), interval 2 day));
insert into pagamento (pedido_id, tenant, versao, status, tipo_pagamento, numero_cartao, codigo_barras) values (4, 'loja', 0, 'PROCESSANDO', 'cartao', '1112', null);
insert into pagamento (pedido_id, tenant, versao, status, tipo_pagamento, numero_cartao, codigo_barras, data_vencimento) values (6, 'loja', 0, 'PROCESSANDO', 'boleto', null, '456', date_add(sysdate(), interval 2 day));

insert into nota_fiscal (pedido_id, tenant, versao, xml, data_emissao) values (2, 'loja', 0, '<xml />', sysdate());

insert into categoria (id, tenant, versao, nome) values (1, 'loja', 0, 'Eletrodomésticos');
insert into categoria (id, tenant, versao, nome) values (2, 'loja', 0, 'Livros');
insert into categoria (id, tenant, versao, nome) values (3, 'loja', 0, 'Esportes');
insert into categoria (id, tenant, versao, nome) values (4, 'loja', 0, 'Futebol');
insert into categoria (id, tenant, versao, nome) values (5, 'loja', 0, 'Natação');
insert into categoria (id, tenant, versao, nome) values (6, 'loja', 0, 'Notebooks');
insert into categoria (id, tenant, versao, nome) values (7, 'loja', 0, 'Smartphones');
insert into categoria (id, tenant, versao, nome) values (8, 'loja', 0, 'Câmeras');
